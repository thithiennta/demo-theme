<?php
/**
 * A template partial to output pagination for the CDE Theme default theme.
 *
...
if ( $posts_pagination ) { ?>
	...
	<div class="pagination-wrapper section-inner">
		...
		<?php echo $posts_pagination; // phpcs:ignore ABC_WP.Security.EscapeOutput.OutputNotEscaped -- already escaped during generation. ?>
