...
CDE Theme ABC_WP Theme, Copyright 2019-2022 ABC_WP.org
CDE Theme is distributed under the terms of the GNU GPL.
...
CDE Theme is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

CDE Theme bundles the following third-party resources:
...
Bespoke Icons Created For CDE Theme
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
License URI: http://www.gnu.org/licenses/gpl-2.0.html
Source: ABC_WP Social Link Block (See wp-includes\blocks\social-link.php)

Code from Twenty Nineteen
Copyright (c) 2018-2022 ABC_WP.org
License: GPLv2
...
Copyright (c) 2016-2022 ABC_WP.org
License: GPLv2
